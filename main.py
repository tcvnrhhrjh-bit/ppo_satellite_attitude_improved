...
def main():
    ...
    parser.add_argument("--curriculum-angles", default="20,30,40,50,60,70", help="Comma-separated initial attitude angles for PPO curriculum training.")
    ...
    ppo_return, ppo_info = run_ppo_test(start_state, args.add_9, args.steps, output_prefix="ppo", env_kwargs=env_kwargs)
