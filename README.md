...
7. Curriculum learning was added for PPO.
   ...
   - The default training schedule starts from 20 degrees and gradually increases through 30, 40, 50, 60, and 70 degrees.
...
The default PPO training uses curriculum learning:

```bash
python main.py --epochs 300 --steps 500 --curriculum-angles 20,30,40,50,60,70
```
