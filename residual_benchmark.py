...
def controller_action(
    ...
    if name == "pd_ppo_residual":
        ...
        return np.clip(u_total, -torque_limit, torque_limit)
...
def main():
    ...
    if args.use_telemetry_reset:
        telemetry_states, telemetry_records, telemetry_metadata = load_telemetry_states(
            args.telemetry_dir,
    ...
    for trial in range(args.trials):
        if args.use_telemetry_reset:
            start_state = telemetry_states[trial % len(telemetry_states)].copy()
